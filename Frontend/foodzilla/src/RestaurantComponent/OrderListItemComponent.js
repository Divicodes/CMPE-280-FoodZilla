...
export class OrderListItemComponent extends Component {
  ...
  render() {
    ...
    console.log("Order status for order id", order.ORDER_ID, order.ORD_STATUS);
    return (
      <div>
        <Formik
          initialValues={{
            ...
            <li className="list-group-item" key={order.ORDER_ID}>
              <div className="row">
                <div className="col-sm-2">
                  ...
                  <Link
                    to={`/restaurant/${order.REST_ID}/view/customer/${order.CUST_ID}`}
                  >
                    View Customer
                  </Link>
                </div>
                ...
                <p className="col-sm-2">Total Amount:$ {order.AMOUNT}</p>
                <div className="col-sm-3">
                  {order.type === "pickup" ? (
                    <div>
                      <Field
