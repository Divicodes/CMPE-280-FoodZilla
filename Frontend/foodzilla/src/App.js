    ...
    <Router>
      <div className="App">
        <Switch>
          ...
          <Route
            exact
            path="/restaurant/:restId/dish/:dishId"
          ...
          <RestaurantProtectedRoute
            exact
            path="/restaurant/:restId/orderslist"
          ...
          <RestaurantProtectedRoute
            exact
            path="/restaurant/landing/:profileId"
            component={RestaurantLanding}
          ></RestaurantProtectedRoute>
          <RestaurantProtectedRoute
            exact
            path="/restaurant/profile/:profileId"
            component={RestaurantProfile}
          ></RestaurantProtectedRoute>
          <RestaurantProtectedRoute
            exact
            path="/restaurant/:restId/view/customer/:custId"
          ...
          <CustomerProtectedRoute
            exact
            path="/customer/profile/:custId"
            component={CustomerProfile}
          ></CustomerProtectedRoute>
          <CustomerProtectedRoute
            exact
            path="/customer/landing/:custId"
            component={CustomerLanding}
          ></CustomerProtectedRoute>
          <CustomerProtectedRoute
            exact
            path="/customer/:custId/restaurant/:restId"
            component={CustomerRestComponent}
          ></CustomerProtectedRoute>
          <CustomerProtectedRoute
            exact
            path="/customer/:custId/favourites"
            component={CustomerFavouritesList}
          ></CustomerProtectedRoute>
          <CustomerProtectedRoute
            exact
            path="/customer/checkout/:custId"
            component={CheckoutComponent}
          ></CustomerProtectedRoute>
          <CustomerProtectedRoute
            exact
            path="/customer/orders/:custId"
