...
export class CustomerOrders extends Component {
  ...
  getAddressList = () => {
    ...
    axios
      .all([axios.get(getIntialAddress), axios.get(getAllDeliveryAddress)])
      .then((res) => {
        let list = [];
        let intialAddress = {
          add_id: 0,
  ...
  handleFilter = (e) => {
    ...
    switch (e.target.value) {
      ...
      case "new order":
        ...
        this.setState({ orderList: filteredList, filter: "new order" }, () =>
          console.log(this.state)
        );
        break;
      case "orderPreparing":
        ...
        this.setState(
          { orderList: filteredList, filter: "orderPreparing" },
          () => console.log(this.state)
        );
        break;
      case "pickupReady":
        ...
        this.setState({ orderList: filteredList, filter: "pickupReady" }, () =>
          console.log(this.state)
        );
        break;
      case "picked up":
        ...
        this.setState({ orderList: filteredList, filter: "picked up" }, () =>
          console.log(this.state)
        );
        break;
      case "onTheWay":
        ...
        this.setState({ orderList: filteredList, filter: "onTheWay" }, () =>
          console.log(this.state)
        );
        break;
      case "delivered":
        ...
        this.setState({ orderList: filteredList, filter: "delivered" }, () =>
          console.log(this.state)
        );
        break;
    }
  ...
  render() {
    return (
      <div>
        <NavComponent
          view="customer"
          cid={this.props.match.params.custId}
        ></NavComponent>
        <div>
          <div>
            <select
              className="form-control col-sm-6 mt-4 ml-3"
              ...
              {(this.state.rowsPerPage > 0
                ...
                return (
                  <OrderListItem
                    ...
                    reloadOrder={this.getAllOrdersList}
                  ></OrderListItem>
                );
              })}
            </List>
